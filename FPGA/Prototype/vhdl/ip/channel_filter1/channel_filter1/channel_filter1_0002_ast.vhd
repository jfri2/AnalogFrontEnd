...
entity channel_filter1_0002_ast is
  generic (
  INWIDTH             : integer := 16;
...
component channel_filter1_0002_rtl is
  port (
...
end component channel_filter1_0002_rtl;
...
hpfircore: channel_filter1_0002_rtl
   port map (
     xIn_v     => data_valid,
     xIn_c     => "00000000",
